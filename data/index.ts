export const navItems = [
  ...
  export const gridItems = [
    {
      id: 1,
      title: "Me gusta trabajar colaborativamente fomentando el trabajo en equipo",
      description: "",
    ...
    {
      id: 3,
      title: "Mi stack técnologico",
      description: "Mejorando contantemente mi",
      className: "lg:col-span-2 md:col-span-3 md:row-span-2",
      imgClassName: "",
    ...
    {
      id: 4,
      title: "Muy entusiasta y con pasión por la programación",
      description: "",
    ...
    {
      id: 5,
      title: "Actualmente realizando proyectos personales",
      description: "",
